...
if (isset( $_POST['Curso_Busqueda']
    ...
    $curso_busqueda = $_POST['Curso_Busqueda'];
    $sql_curso_busqueda = "SELECT * FROM repositorio.cursos WHERE Curso_Id = $curso_busqueda";
    $all_curso_busqueda = mysqli_query($con, $sql_curso_busqueda);
}
...
?>
    ...
    <h1 style="margin:1em 0 0 0">Modificar Curso</h1>
...
<!-- -->
            ...
            <div class="form-group">
                <label for="Curso_Busqueda">Nombre</label>
                <select name="Curso_Busqueda" id="Curso_Busqueda">
                        <?php
            ...
            <input value="<?php echo $curso_busqueda ?>" hidden name="Curso_Busqueda_Id" id="Curso_Busqueda_Id">
            <?php 
                if (isset( $_POST['Curso_Busqueda']
                )) {
                    ?>
                    ...
                    <div class="form-group">
                        <label for="MOD_Curso_Nombre">Nombre</label>
                        
                        <input name="MOD_Curso_Nombre" id="MOD_Curso_Nombre" required
                            <?php
                            while ($cursos_1 = mysqli_fetch_array($all_curso_busqueda, MYSQLI_ASSOC)) :;
                            ?>
                                value="<?php echo $cursos_1["Curso_Nombre"];?>">
                        <?php
                        endwhile;
                        ?>
                    </div>
                ...
                <br>
                <button name="mod_alumno" type="submit" value="mod_alumno" formaction="update_curso.php" class="btn btn-primary">Modificar Curso</button>
                <?php
                    }
            ?>
            <!--   -->
