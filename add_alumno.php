...
?>
    ...
    <h1 style="margin:1em 0 0 0">Añadir Alumno</h1>
    ...
    <div class="d-flex justify-content-center align-items-center">
        ...
        <form class="p-5 rounded shadow" style="width: 30em" action="insert_alumno.php" method="POST">
	    ...
	    <?php } ?>
            ...
            <div class="form-group">
                ...
                <input name="INS_Alumno_Nombre" type="text" id="INS_Alumno_Nombre" placeholder="Nombre" required>
            </div>


            <div class="form-group">
                <label for="INS_Alumno_Apellido_1">Primer Apellido</label>
                <input name="INS_Alumno_Apellido_1" type="text" id="INS_Alumno_Apellido_1" placeholder="Primer apellido" required>
            </div>
            
            <div class="form-group">
                <label for="INS_Alumno_Apellido_2">Segundo Apellido</label>
                <input name="INS_Alumno_Apellido_2" type="text" id="INS_Alumno_Apellido_2" placeholder="Segundo apellido">
            </div>
            <br>
            <button name="submit_alumno" type="submit" value="submit_alumno" class="btn btn-primary">Añadir Alumno</button>
        </form>
    </div>
