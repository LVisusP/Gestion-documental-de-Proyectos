...
?>
    ...
    <h1 style="margin:1em 0 0 0">Añadir Curso</h1>
    ...
    <div class="d-flex justify-content-center align-items-center">
        ...
        <form class="p-5 rounded shadow" style="width: 30em" action="insert_curso.php" method="POST">
	    ...
	    <?php } ?>
            ...
            <div class="form-group">
                <label for="INS_Curso_Nombre">Curso (en formato 2*/2*):</label>
                <input name="INS_Curso_Nombre" type="text" id="INS_Curso_Nombre" placeholder="2*/2*">
            </div>
            <br>
            <button name="submit_curso" type="submit" value="submit_curso" class="btn btn-primary">Añadir Curso</button>
        </form>
    </div>
